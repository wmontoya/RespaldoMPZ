...
export default async function handler(req: NextApiRequest, res: NextApiResponse, user: any) {
    ...
    try {
        ...
        const response = await fetch(`${API_ODOO_REQUEST}/api/v1/yaipan/persona/pendientes`, {
            method: 'POST',
            headers: {
            ...
            body: JSON.stringify({
                params: {
                    ...
                    filtro: parsedBody.data.filtro,
                    estado: parsedBody.data.estado
                },
            }),
        });
        ...
        return res.status(200).json({ success: true, pendientes: json.result.result });
