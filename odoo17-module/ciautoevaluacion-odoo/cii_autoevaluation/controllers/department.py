...
class ReportController(http.Controller):
    @http.route('/api/v1/department/autoevaluation/download_excel_report', type='http', auth='user', methods=['GET'], csrf=False)
    def download_excel_report(self, **kwargs):
        try:
            ...
            report_service = request.env['report.survey'].sudo()
